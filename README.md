...
<ul>
    <li>学习了设计相关的基础练习,如文本和颜色的处理方式</li>
    <li>字体上,学习了衬线字体和无衬线字体,了解了字体如何作用与web的整体风格</li>
    <li>颜色上,对网站的颜色选择有了基本认知,了解了主色和灰色,一点细节,用a标签时只需要设置padding属性即可实现按钮效果,不需要buttom</li>
</ul>

##### DAY15 10.10

<ul>
   <li>其实这不应该是第十五天，我有几天没有写日志了😐</li>
   <li>学习了border-ridus的运用</li>
   <li>学习了shadow的运用 有box-shadow 和 text-shadow之分，知道了所谓阴影就是创建一个3D的空间实现相关的视觉效果</li>
   <li>学习了如何设计图标，利用一些便捷的图标网站，还有对于SVG专用的stoke属性，对于普通元素是用border</li>
   <li>还有一些颜色的选择，图片尺寸根据分辨率的设置等等</li>
</ul>
